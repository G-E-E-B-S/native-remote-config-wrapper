...
%module(target_namespace="remoteconfig") remoteconfig
...
//
%ignore remoteconfig::FirebaseRemoteConfig::FirebaseRemoteConfig;
%ignore remoteconfig::FirebaseRemoteConfig::init;
%ignore remoteconfig::FirebaseRemoteConfig::setListener;
%ignore remoteconfig::FirebaseRemoteConfig::getListener;
