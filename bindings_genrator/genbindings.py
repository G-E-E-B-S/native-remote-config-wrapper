...
projectRoot = '/Applications/CocosCreator/Creator/3.6.2/CocosCreator.app/Contents/Resources/resources/3d/engine/native' # os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
currentDir = os.path.dirname(os.path.abspath(__file__))
defaultOutputDir = '%s/../bindings/auto' % currentDir
...
def main():
    ...
    config.set('DEFAULT', 'plugin_dir', currentDir)
